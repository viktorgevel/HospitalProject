...
<div class="col-md-5">
    <form class="form-horizontal" action="addworkingtime" method="POST">
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="idDoctor" class="col-md-2 control-label">
                    Оберіть лікаря
                </label>
                <div class="col-md-4">
                    <select id="idDoctor" name="selectdoctor" style="width: 100%; display: block;">
        ...
        <div class="col-md-offset-2 col-md-8">
            <button type="submit" class="btn btn-default" value="add">Create working time</button>
        </div>
    </form>
